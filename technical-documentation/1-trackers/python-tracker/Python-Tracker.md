...
This page refers to version 0.5.0 of the Snowplow Python Tracker. Click [here] [python-0.3] for the corresponding documentation for version 0.3.0, or [here][python-0.2] for version 0.2.0.
