...
*This page refers to version 2.5.1 of the Snowplow JavaScript Tracker.*  
...
*Important note regarding testing:* `"//d1fc8wv8zag5ca.cloudfront.net/2.5.1/sp.js"` is the URL from which sp.js should be fetched, and will automatically be prepended with "http:" or "https:" depending on the page's protocol. But if you wish to try out Snowplow locally, using an HTML file on disk whose URI starts with "file://", you should manually insert "http:", changing it to `"http://d1fc8wv8zag5ca.cloudfront.net/2.5.1/sp.js"`.
