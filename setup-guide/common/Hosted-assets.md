...
The minified JavaScript tracker is hosted on CloudFront against its full semantic version:
    ...
    http(s)://d1fc8wv8zag5ca.cloudfront.net/2.4.1/sp.js
...
[hadoop-enrich-download]: http://d2io1hx8u877l0.cloudfront.net/3-enrich/hadoop-etl/snowplow-hadoop-etl-0.12.0.jar
