...
The current version of the Snowplow Java Tracker is 0.5.2.
...
dependencies {
    ...
    compile 'com.snowplowanalytics:snowplow-java-tracker:0.5.2'
}
```
...
// Dependency
val snowplowTracker = "com.snowplowanalytics"  % "snowplow-java-tracker"  % "0.5.2"
```
