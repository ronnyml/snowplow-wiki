...
n.src=w;g.parentNode.insertBefore(n,g)}}(window,document,"script","//d1fc8wv8zag5ca.cloudfront.net/2.1.1/sp.js","snowplow"));
...
The reference to `://d1fc8wv8zag5ca.cloudfront.net/2.1.1/sp.js` loads `sp.js`, the Snowplow JavaScript Tracker. The version loaded is the version [hosted by the Snowplow team from our own Cloudfront subdomain](https://github.com/snowplow/snowplow/wiki/hosted-assets).
...
n.src=w;g.parentNode.insertBefore(n,g)}}(window,document,"script","//://{{SUBDOMAIN}}.cloudfront.net/sp.js.cloudfront.net/2.1.1/sp.js","snowplow"));
```
